...
const FlipDiv = ({
  ...
  return (
    <div
      className={`w-fit min-w-16 rounded-lg border border-primary-500 bg-primary-500/5 text-sm text-primary-500 hover:bg-primary-500 hover:text-white ${className}`}
    >
      <motion.div
        initial="initial"
        whileHover="hovered"
